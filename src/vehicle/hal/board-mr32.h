...
class MR32Board : public BoardInterface {
 public:
  static MR32Board& getInstance(void* params = nullptr) {
    static MR32Board instance(params);  // Meyers Singleton
    return instance;
  }
  ...
  void init() {
    ...
    /// initialise the gyro
    /// kick off systick
    printf("MR32Board initialiseing\n");
  }
 ...
 private:
  ...
  MR32Board& operator=(const MR32Board) = delete;
  MR32Board(const MR32Board&) = delete;
  MR32Board& operator=(const MR32Board&) = delete;
  MR32Board(MR32Board&&) = delete;
  MR32Board& operator=(MR32Board&&) = delete;
};
