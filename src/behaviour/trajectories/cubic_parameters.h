...
/// Note: parameters for google tests. Fields have a diffeent meaning
/// Note: Do not copy ar running parameters
const CubicTurnParameters test_cubic_params[] = {
//   max speed     in turn, out   angle   len
    {     500,    200,  90, 100,  -90.0,  150 },  //  SS90SR
    {     500,    200,  90, 100,   90.0,  150 },  //  SS90SL
    {    1000,    210,  75, 120,  -90.0,  195 },  //  SS90FR
    {    1000,    210,  70, 115,   90.0,  195 },  //  SS90FL
    {    1000,    210,  80, 110, -180.0,  371 },  //  SS180FR
    {    1000,    210,  80, 110,  180.0,  371 },  //  SS180FL
    {     500,    200,  45,  75,  -45.0,  100 },  //  SD45R
    {     500,    200,  45,  75,   45.0,  100 },  //  SD45L
    {     500,    200,  73,  85, -135.0,  230 },  //  SD135R
    {     500,    200,  73,  70,  135.0,  230 },  //  SD135L
    {     500,    165,  90, 175,  -45.0,  100 },  //  DS45R
    {     500,    165,  85, 175,   45.0,  100 },  //  DS45L
    {     500,    165,  65, 130, -135.0,  220 },  //  DS135R
    {     500,    165,  70, 130,  135.0,  220 },  //  DS135L
    {     500,    165,  65,  85,  -90.0,  124 },  //  DD90R
    {     500,    165,  63,  85,   90.0,  124 },  //  DD90L
    {     500,    210, 120,  70,  -90.0,  116 },  //  SS90ER
    {     500,    210, 120,  65,   90.0,  116 },  //  SS90EL
};
// clang-format on
