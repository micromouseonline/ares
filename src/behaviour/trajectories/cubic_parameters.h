...
//   max speed     in turn, out   angle   len
    {     500,    200,   0, 100,  -90.0,  150 },  //  SS90SR
    {     500,    200,   0, 100,   90.0,  150 },  //  SS90SL
    {    1000,    118,   0, 118,  -90.0,  195 },  //  SS90FR
    {    1000,    118,   0, 118,   90.0,  195 },  //  SS90FL
    {    1000,    118,   0, 118, -180.0,  371 },  //  SS180FR
    {    1000,    118,   0, 118,  180.0,  371 },  //  SS180FL
    {     500,    200,   0,  75,  -45.0,  100 },  //  SD45R
    {     500,    200,   0,  75,   45.0,  100 },  //  SD45L
    {     500,    200,   0,  80, -135.0,  230 },  //  SD135R
    {     500,    200,   0,  80,  135.0,  230 },  //  SD135L
    {     500,    165,   0, 175,  -45.0,  100 },  //  DS45R
    {     500,    165,   0, 175,   45.0,  100 },  //  DS45L
    {     500,    165,   0, 130, -135.0,  220 },  //  DS135R
    {     500,    165,   0, 130,  135.0,  220 },  //  DS135L
    {     500,    165,   0,  85,  -90.0,  124 },  //  DD90R
    {     500,    165,   0,  85,   90.0,  124 },  //  DD90L
    {     500,    210,   0,  70,  -90.0,  116 },  //  SS90ER
    {     500,    210,   0,  70,   90.0,  116 },  //  SS90EL
};
// clang-format on
